...
export default function Financial_Dashboard() {
  return (
    <div className="min-h-screen bg-gray-100 flex flex-col items-center justify-center text-center relative">
      <h1 className="text-5xl font-bold mb-8 text-blue-800">Financial Dashboard</h1>
      <iframe
        title="Financial Dashboard"
        width="1200"
        height="800"
        src="https://app.powerbi.com/view?r=eyJrIjoiN2NiZjcwZGEtZmQzMS00MDI1LWIxODYtZjM2ZGQxNGVjNTU5IiwidCI6IjZmNDQzMmRjLTIwZDItNDQxZC1iMWRiLWFjMzM4MGJhNjMzZCIsImMiOjEwfQ%3D%3D"
        frameBorder="0"
        allowFullScreen
      ></iframe>
      ...
      <Link href="/ManagerPage/Inventory" className="absolute bottom-20 right-4">
